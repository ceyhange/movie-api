...
import static com.gencay.movie.utils.constants.AppConfig.*;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        com.gencay.movie.user.User credentials = new ObjectMapper().readValue(request.getInputStream(), com.gencay.movie.user.User.class);
